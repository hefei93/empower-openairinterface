...
// QuickFix to enable RRC measurement reporting. i.e To disable the EXMIMO_IOT
// flag. Beware!! This parameter is used in 3 other places.
#if defined(OAI_USRP)
  #undef EXMIMO_IOT
#endif
  ...
  *DRB_configList2 = CALLOC(1, sizeof(**DRB_configList2));
  ...
  memset(buffer, 0, RRC_BUF_SIZE);
   ...
   size = do_RRCConnectionReconfiguration(ctxt_pP,
            ...
            ue_context_pP->ue_context.QuantityConfig,
            NULL,
            NULL,
					  NULL,
...
//-----------------------------------------------------------------------------
{
  ...
  MeasObjectToAddMod_t               *MeasObj, *MeasObj2               = NULL;
  ...
  *logicalchannelgroup_drb = 1;
  ...
  /* Reset the flag indicating the UE measurements are not reconfigured. */
  ue_context_pP->ue_context.meas_reconfig_flag = 0;
  ...
  *sr_ProhibitTimer_r9 = 0;   // SR tx on PUCCH, Value in number of SR period(s). Value 0 = no timer for SR, Value 2= 2*SR
  ...
  // Add MeasId2 to ue_context
  // ue_context_pP->ue_context.MeasId[2] = MeasId2;
  ...
  // Add MeasId3 to ue_context
  // ue_context_pP->ue_context.MeasId[3] = MeasId3;
  ...
  // Add MeasId4 to ue_context
  // ue_context_pP->ue_context.MeasId[4] = MeasId4;
  ...
  // Add MeasId5 to ue_context
  // ue_context_pP->ue_context.MeasId[5] = MeasId5;
  ...
  // MeasObj->measObject.choice.measObjectEUTRA.carrierFreq = 3150; //band 7, 2.66GHz
  // vodafone band
  // MeasObj->measObject.choice.measObjectEUTRA.carrierFreq = 6400; //band 3, 1879MHz
  ...
  memset((void *)MeasObj2, 0, sizeof(*MeasObj2));

  MeasObj2->measObjectId = 2;
  MeasObj2->measObject.present = MeasObjectToAddMod__measObject_PR_measObjectEUTRA;
  // MeasObj2->measObject.choice.measObjectEUTRA.carrierFreq = 3150; //band 7, 2.66GHz
  // vodafone band
  ...
  // CellsToAddModList = MeasObj2->measObject.choice.measObjectEUTRA.cellsToAddModList;
  ...
  ReportConfigToAddMod_t *ReportConfig_per7 = CALLOC(1, sizeof(*ReportConfig_per7));
  ...
  // ReportConfig_per->reportConfig.choice.reportConfigEUTRA.triggerType.choice.periodical.purpose =
  //   ReportConfigEUTRA__triggerType__periodical__purpose_reportCGI;
  ...
  ReportConfig_per->reportConfig.choice.reportConfigEUTRA.reportInterval = ReportInterval_ms10240;
  ...
  // ReportConfig_per->reportConfig.choice.reportConfigEUTRA.ext2 = CALLOC(1, sizeof(*(ReportConfig_per->reportConfig.choice.reportConfigEUTRA.ext2)));
  ...
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.triggerType.present =
    ReportConfigEUTRA__triggerType_PR_periodical;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.triggerType.choice.periodical.purpose =
    ReportConfigEUTRA__triggerType__periodical__purpose_reportStrongestCells;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.triggerType.choice.periodical.purpose =
  //   ReportConfigEUTRA__triggerType__periodical__purpose_reportCGI;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.triggerQuantity = ReportConfigEUTRA__triggerQuantity_rsrp;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.reportQuantity = ReportConfigEUTRA__reportQuantity_sameAsTriggerQuantity;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.reportQuantity = ReportConfigEUTRA__reportQuantity_both;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.maxReportCells = 2;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.reportInterval = ReportInterval_ms120;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.reportInterval = ReportInterval_ms10240;
  ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.reportAmount = ReportConfigEUTRA__reportAmount_infinity;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1 = CALLOC(1, sizeof(*(ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1)));
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1->si_RequestForHO_r9 = CALLOC(1, sizeof(long));
  // *ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1->si_RequestForHO_r9 = ReportConfigEUTRA__ext1__si_RequestForHO_r9_setup;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1->ue_RxTxTimeDiffPeriodical_r9 = CALLOC(1, sizeof(long));
  // *ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext1->ue_RxTxTimeDiffPeriodical_r9 = ReportConfigEUTRA__ext1__ue_RxTxTimeDiffPeriodical_r9_setup;
  // ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext2 = CALLOC(1, sizeof(*(ReportConfig_per7->reportConfig.choice.reportConfigEUTRA.ext2)));
  ...
  // a1_Threshold.present = ThresholdEUTRA_PR_threshold_RSRQ;
  ReportConfig_A1->reportConfig.choice.reportConfigEUTRA.triggerType.choice.event.eventId.choice.eventA1.
  ...
  // Add ReportConfig to ue_context
  // ue_context_pP->ue_context.ReportConfig[1] = ReportConfig_A1;

  // Configure MeasGapConfig
  measGapConfig = CALLOC(1, sizeof(*measGapConfig));
  memset((void *)measGapConfig, 0, sizeof(*measGapConfig));
  ...
  *quantityConfig->quantityConfigEUTRA->filterCoefficientRSRQ = FilterCoefficient_fc4;
  // Add quantityConfig to ue_context
  ue_context_pP->ue_context.QuantityConfig = quantityConfig;
  ...
  if (ho_state == 1 /*HO_MEASURMENT */ ) {
    ...
    // Add ReportConfig to ue_context
    // ue_context_pP->ue_context.ReportConfig[2] = ReportConfig_A2;
    ...
    // Add ReportConfig to ue_context
    // ue_context_pP->ue_context.ReportConfig[3] = ReportConfig_A3;
    ...
    // Add ReportConfig to ue_context
    // ue_context_pP->ue_context.ReportConfig[4] = ReportConfig_A4;
    ...
    // Add ReportConfig to ue_context
    // ue_context_pP->ue_context.ReportConfig[5] = ReportConfig_A5;
    ...
    *rsrp = 20;
    ...
    /* Not setting handover parameter for now - implemented later*/
  ...
  size = do_RRCConnectionReconfiguration(ctxt_pP,
                                         ...
                                         NULL, // Not setting Sparams for now. (struct MeasConfig__speedStatePars*)Sparams,
                                         NULL, // Not setting rsrp for now. (RSRP_Range_t*)rsrp,
                                         (C_RNTI_t*)cba_RNTI,
                                         (struct RRCConnectionReconfiguration_r8_IEs__dedicatedInfoNASList*)dedicatedInfoNASList
#if defined(Rel10) || defined(Rel14)
                                         , (SCellToAddMod_r10_t*)NULL
...
//-----------------------------------------------------------------------------
{
  ...
  if (measResults2 != NULL) {
    ...
    xer_fprint(stdout, &asn_DEF_MeasResults, (void *)measResults2);
       ...
       */
      struct rrc_meas_params *p = malloc(sizeof(struct rrc_meas_params));
      /* Fill the rnti of the UE which got the report. */
      p->rnti = ctxt_pP->rnti;
...
//-----------------------------------------------------------------------------
{
  ...
  *sr_ProhibitTimer_r9 = 0;   // SR tx on PUCCH, Value in number of SR period(s). Value 0 = no timer for SR, Value 2= 2*SR
  ...
  for (i=0; i < MAX_MEAS_ID; i++) {
    if (ue_context_pP->ue_context.MeasId[i] != NULL) {
      ASN_SEQUENCE_ADD(&MeasId_list->list, ue_context_pP->ue_context.MeasId[i]);
    }
  }
  ...
  for (i=0; i < MAX_MEAS_OBJ; i++) {
    if (ue_context_pP->ue_context.MeasObj[i] != NULL) {
      ASN_SEQUENCE_ADD(&MeasObj_list->list, ue_context_pP->ue_context.MeasObj[i]);
    }
  }
  ...
  for (i=0; i < MAX_MEAS_CONFIG; i++) {
    if (ue_context_pP->ue_context.ReportConfig[i] != NULL) {
      ASN_SEQUENCE_ADD(&ReportConfig_list->list, ue_context_pP->ue_context.ReportConfig[i]);
    }
  }
  ...
  MeasGapConfig_t *measGapConfig = ue_context_pP->ue_context.measGapConfig;
  ...
  quantityConfig = ue_context_pP->ue_context.QuantityConfig;
  /*quantityConfig = CALLOC(1, sizeof(*quantityConfig));
  memset((void *)quantityConfig, 0, sizeof(*quantityConfig));
...
#   endif
  ...
  if (ul_dcch_msg->message.present == UL_DCCH_MessageType_PR_c1) {
    ...
    case UL_DCCH_MessageType__c1_PR_csfbParametersRequestCDMA2000:
      LOG_I(RRC,"-------------->[MSG] RRC csfbParametersRequestCDMA2000\n");
      break;

    case UL_DCCH_MessageType__c1_PR_measurementReport:
      LOG_I(RRC,"-------------->[MSG] RRC Measurement report\n");
    ...
    case UL_DCCH_MessageType__c1_PR_rrcConnectionReconfigurationComplete:
      LOG_I(RRC,"-------------->[MSG] RRC Connection Reconfiguration Complete\n");
#ifdef RRC_MSG_PRINT
  ...
  if (ue_context_p->ue_context.meas_reconfig_flag != 1) {
    rrc_eNB_process_RRCConnectionReconfigurationComplete(
          ctxt_pP,
          ue_context_p,
...
#if defined(ENABLE_ITTI)
  #if defined(ENABLE_USE_MME)
      /* Making sure that no message is sent when
        UE measurement configuration is reconfigured. */
      if (EPC_MODE_ENABLED == 1 && ue_context_p->ue_context.meas_reconfig_flag != 1) {
	if (dedicated_DRB == 1){
...
#endif
#endif
      /* Reset the measurement reconfiguration indicator flag. */
      ue_context_p->ue_context.meas_reconfig_flag = 0;
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_rrcConnectionReestablishmentComplete:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC Connection Reestablishment Complete\n");
#ifdef RRC_MSG_PRINT
    ...
    case UL_DCCH_MessageType__c1_PR_rrcConnectionSetupComplete:
      LOG_I(RRC,"-------------->[MSG] RRC Connection SetupComplete\n");
#ifdef RRC_MSG_PRINT
    ...
    case UL_DCCH_MessageType__c1_PR_securityModeComplete:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC Security Mode Complete\n");
#ifdef RRC_MSG_PRINT
    ...
    case UL_DCCH_MessageType__c1_PR_securityModeFailure:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC Security Mode Failure\n");
#ifdef RRC_MSG_PRINT
...
//#warning "LG Removed rrc_eNB_generate_UECapabilityEnquiry after receiving securityModeFailure"
    ...
    case UL_DCCH_MessageType__c1_PR_ueCapabilityInformation:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC UECapablility Information \n");
#ifdef RRC_MSG_PRINT
    ...
    case UL_DCCH_MessageType__c1_PR_ulHandoverPreparationTransfer:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_ulHandoverPreparationTransfer\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_counterCheckResponse:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_counterCheckResponse\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_ueInformationResponse_r9:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_ueInformationResponse_r9\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_proximityIndication_r9:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_proximityIndication_r9\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_rnReconfigurationComplete_r10:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_rnReconfigurationComplete_r10\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_mbmsCountingResponse_r10:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_mbmsCountingResponse_r10\n");
      break;
    ...
    case UL_DCCH_MessageType__c1_PR_interFreqRSTDMeasurementIndication_r10:
      ...
      LOG_I(RRC,"-------------->[MSG] RRC PR_interFreqRSTDMeasurementIndication_r10\n");
      break;
#endif
